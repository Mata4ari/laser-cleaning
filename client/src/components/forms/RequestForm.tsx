...
// Шаги формы с понятными заголовками
...
const RequestForm: React.FC = () => {
  ...
  // Выводим соответствующий контент в зависимости от шага
          ...
          <Zoom in={completed}>
            <Box sx={{ textAlign: "center", py: 4 }}>
              ...
              <Typography
                ...
                paragraph
                sx={{ maxWidth: 450, mx: "auto", mb: 4 }}
              >
                Спасибо за обращение! Наш специалист свяжется с вами в ближайшее
                время по указанным контактным данным.
              </Typography>
              <Button
                variant="contained"
                onClick={handleReset}
